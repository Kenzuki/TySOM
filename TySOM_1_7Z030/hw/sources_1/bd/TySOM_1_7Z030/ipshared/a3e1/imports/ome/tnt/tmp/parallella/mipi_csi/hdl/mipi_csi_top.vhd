...
architecture rtl of mipi_csi_top is
	...
	signal data1_se			: std_logic;
	signal data2_se			: std_logic;
	signal clk_se			: std_logic;

begin

	--------------------------------------------------------------------------
	-- Dummy code for SE wires
	--------------------------------------------------------------------------
	data1_se <= cam_dn0_se and cam_dp0_se;
	data2_se <= cam_dn1_se and cam_dp1_se;
	clk_se <= cam_cn_se and cam_cp_se;
